  ...
  return (
    ...
    <div className="bg-[#faf9f7] text-[#1A1C1A] antialiased">
      ...
      <section className="bg-[#f1f0ee] pb-16 pt-2 md:pb-24 md:pt-20">
        <div className="mx-auto max-w-7xl grid lg:grid-cols-2 gap-28 items-start px-6 md:px-0">
          <Reveal>
              ...
              <div className="mb-7">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button
                    ...
                    className={`flex flex-col items-center justify-center gap-2 rounded-[8px] border py-6 transition-colors ${
