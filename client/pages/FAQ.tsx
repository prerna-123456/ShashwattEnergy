      ...
      >
        ...
        <span
          className={`shrink-0 flex items-center justify-center w-8 h-8 rounded-full transition-all duration-300 ${
            open ? "bg-[#BA0013] text-white rotate-45" : "bg-[#f1f0ee] text-[#5D3F3C]"
          }`}
        >
        ...
        <div className="relative z-10 mx-auto flex min-h-115 max-w-7xl items-center px-6 pt-30 md:min-h-140 md:px-0 md:pt-32 lg:min-h-138.5">
          <div className="max-w-185">
            ...
            <p
              ...
              className={`mt-7 max-w-140 text-[18px] font-medium leading-[1.55] text-white transition-all duration-700 ease-out md:text-[16px] ${
                heroIn ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
              }`}
            >
